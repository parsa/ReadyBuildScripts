...
tar xf clang-tools-extra-3.7.0.src.tar.xz
mv clang-tools-extra-3.7.0.src extra
cd ../.. # clang
wget http://llvm.org/releases/3.7.0/lldb-3.7.0.src.tar.xz
tar xf lldb-3.7.0.src.tar.xz
mv lldb-3.7.0.src lldb
wget http://llvm.org/releases/3.7.0/lld-3.7.0.src.tar.xz
tar xf lld-3.7.0.src.tar.xz
mv lld-3.7.0.src lld
cd .. # tools
cd projects
wget http://llvm.org/releases/3.7.0/compiler-rt-3.7.0.src.tar.xz
tar xf compiler-rt-3.7.0.src.tar.xz
mv compiler-rt-3.7.0.src compiler-rt
wget http://llvm.org/releases/3.7.0/libcxxabi-3.7.0.src.tar.xz
tar xf libcxxabi-3.7.0.src.tar.xz
mv libcxxabi-3.7.0.src libcxxabi
wget http://llvm.org/releases/3.7.0/libcxx-3.7.0.src.tar.xz
tar xf libcxx-3.7.0.src.tar.xz
mv libcxx-3.7.0.src libcxx
cd .. # projects
cd .. # llvm
mkdir tmp
cd tmp
