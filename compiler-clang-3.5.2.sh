...
cd ../.. # clang
wget http://llvm.org/releases/3.5.2/lldb-3.5.2.src.tar.xz
tar xf lldb-3.5.2.src.tar.xz
mv lldb-3.5.2.src lldb
wget http://llvm.org/releases/3.5.2/lld-3.5.2.src.tar.xz
tar xf lld-3.5.2.src.tar.xz
mv lld-3.5.2.src lld
cd .. # tools
cd projects
...
wget http://llvm.org/releases/3.5.2/libcxxabi-3.5.2.src.tar.xz
tar xf libcxxabi-3.5.2.src.tar.xz
mv libcxxabi-3.5.2.src libcxxabi
wget http://llvm.org/releases/3.5.2/libcxx-3.5.2.src.tar.xz
tar xf libcxx-3.5.2.src.tar.xz
mv libcxx-3.5.2.src libcxx
cd .. # projects
cd .. # llvm
mkdir tmp
cd tmp
