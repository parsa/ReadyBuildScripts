...
mkdir boost
pushd boost
wget --content-disposition --no-check-certificate https://downloads.sf.net/project/boost/boost/1.58.0/boost_1_58_0.tar.bz2
tar xf boost_1_58_0.tar.bz2
pushd boost_1_58_0
./bootstrap.sh
./b2 stage -j
#./b2 --build-dir=../1.58.0 --layout=versioned toolset=clang-3.5 install -j4
