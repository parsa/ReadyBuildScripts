...
cd clang/tools
wget http://llvm.org/releases/3.6.1/clang-tools-extra-3.6.1.src.tar.xz
tar xf clang-tools-extra-3.6.1.src.tar.xz
mv clang-tools-extra-3.6.1.src extra
cd ../.. # clang
wget http://llvm.org/releases/3.6.1/lldb-3.6.1.src.tar.xz
tar xf lldb-3.6.1.src.tar.xz
mv lldb-3.6.1.src lldb
wget http://llvm.org/releases/3.6.1/lld-3.6.1.src.tar.xz
tar xf lld-3.6.1.src.tar.xz
...
wget http://llvm.org/releases/3.6.1/libcxxabi-3.6.1.src.tar.xz
tar xf libcxxabi-3.6.1.src.tar.xz
mv libcxxabi-3.6.1.src libcxxabi
wget http://llvm.org/releases/3.6.1/libcxx-3.6.1.src.tar.xz
tar xf libcxx-3.6.1.src.tar.xz
