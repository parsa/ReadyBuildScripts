...
cd ../.. # clang
wget http://llvm.org/releases/3.6.0/lldb-3.6.0.src.tar.xz
tar xf lldb-3.6.0.src.tar.xz
mv lldb-3.6.0.src lldb
wget http://llvm.org/releases/3.6.0/lld-3.6.0.src.tar.xz
tar xf lld-3.6.0.src.tar.xz
mv lld-3.6.0.src lld
cd .. # tools
cd projects
...
wget http://llvm.org/releases/3.6.0/libcxxabi-3.6.0.src.tar.xz
tar xf libcxxabi-3.6.0.src.tar.xz
mv libcxxabi-3.6.0.src libcxxabi
wget http://llvm.org/releases/3.6.0/libcxx-3.6.0.src.tar.xz
